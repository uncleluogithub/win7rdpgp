...
wget -O w7x64.img https://bit.ly/uncleluo-win7x64
echo "Download ngrok"
...
echo Downloading File From Uncle LUO
...
echo "===================================="
echo "Username: uncleluo"
echo "Password: I@mCh1nese!"
echo "===================================="
echo "===================================="
echo "Keep supporting Uncle LUO youtube Channel, thank you"
